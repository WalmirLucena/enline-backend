...
describe('Post Model Test', () => {
    let Post = new PostService_1.default();
    ...
    describe('Get Posts with correct data', () => {
        before(() => {
            Sinon.stub(Post.model, 'read').resolves(fileMock_1.fileMockList);
        });
        after(() => {
            Sinon.restore();
        });
    ...
    describe('Delete one Post by Id', () => {
        describe('When the Post exist', () => {
            before(() => {
                Sinon.stub(Post.model, 'delete').resolves(fileMock_1.fileMock);
            });
            after(() => {
                Sinon.restore();
            });
